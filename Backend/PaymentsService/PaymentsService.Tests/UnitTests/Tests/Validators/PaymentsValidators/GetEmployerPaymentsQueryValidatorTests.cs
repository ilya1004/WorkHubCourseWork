...
public class GetEmployerPaymentsQueryValidatorTests
{
    private readonly GetEmployerPaymentsQueryValidator _validator = new();

    [Fact]
    public void Validate_ValidQuery_PassesValidation()
    {
        // Arrange
        var query = new GetEmployerMyPaymentsQuery(
