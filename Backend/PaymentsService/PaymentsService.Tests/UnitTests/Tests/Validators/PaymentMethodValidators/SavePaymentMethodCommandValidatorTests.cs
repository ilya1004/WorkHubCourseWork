...
public class SavePaymentMethodCommandValidatorTests
{
    private readonly SavePaymentMethodCommandValidator _validator = new();

    [Fact]
    public void Validate_ValidPaymentMethodId_PassesValidation()
    {
        // Arrange
        var command = new SavePaymentMethodCommand("pm_1Q0PsIJvEtkwdCNYMSaVuRz6");
    ...
    {
        // Arrange
        var command = new SavePaymentMethodCommand(null!);
    ...
    {
        // Arrange
        var command = new SavePaymentMethodCommand("xxxx_1Q0PsIJvEtkwdCNYMSaVuRz6");
